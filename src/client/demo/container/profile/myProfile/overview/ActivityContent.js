          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                ...
                <p>
                  <span className="inline-text color-primary">James</span> Send
                  you a message <span className="hour">5 hours ago</span>
                </p>
              </div>
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                ...
                />
                <p>
                  <span className="inline-text color-primary">Adam </span>upload
          ...
          <li className="activity-list__single">
            ...
            <div className="activity-content">
              <div className="activity-info">
                ...
                />
                <p>
                  <span className="inline-text color-primary">Mumtahin</span>{' '}
                  has registered <span className="hour">5 hours ago</span>
                </p>
              </div>
              <Link className="activity-more" to="#">
                <Dropdown
